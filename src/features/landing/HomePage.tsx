        ...
        <Container maxWidth="md" sx={{ zIndex: 2, pt: 6 }}>
          <Fade in timeout={1200}>
            <GlassCard elevation={8}>
              <AnimatedLogo src={octoFilmsLogo} alt="Octo Films Logo" aria-label="Octo Films Logo" />
              <Typography
                variant="h2"
                component="h1"
                gutterBottom
              ...
              <Typography variant="h5" color="#fff" sx={{ mb: 2, fontWeight: 400 }}>
                Discover, review, and manage your favorite movies.
                <br />
                <b>Work in Progress:</b> This site is a student project for the Frontend Finals.
              </Typography>
              <Typography variant="body1" color="#f3e5f5" sx={{ mb: 3 }}>
                Sign up or log in to start rating films and join our growing community!
              </Typography>
          ...
          <Box sx={{ mt: 6, mb: 8 }}>
            ...
            >
              ...
              >
                ...
                <CardContent>
                  <Typography>
                    Browse a rich catalog of movies, filter by genre, rating, and more. Find your next favorite film
                    easily!
                  </Typography>
                </CardContent>
              </FeatureCard>
              ...
              >
                ...
                <CardContent>
                  <Typography>
                    Share your thoughts and rate movies. Edit or delete your reviews anytime. Your opinion matters!
                  </Typography>
                </CardContent>
              </FeatureCard>
              <FeatureCard
              ...
              >
                ...
                <CardContent>
                  <Typography>
                    Manage your reviews, favorites, and profile in one place. Enjoy a personalized movie experience.
                  </Typography>
                </CardContent>
              </FeatureCard>
            </Stack>
        ...
        >
          ...
          <Box
            sx={{
              ...
              height: 320,
              borderRadius: '50%',
              background: 'radial-gradient(circle, #8e24aa55 0%, transparent 80%)',
              top: -80,
              left: -80,
          ...
          <Box
            sx={{
              ...
              height: 200,
              borderRadius: '50%',
              background: 'radial-gradient(circle, #3949ab55 0%, transparent 80%)',
              bottom: -60,
              right: -60,
